...
import (
	...
	anthropicprovider "github.com/lansely/ponyclaw/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: ponyclaw auth login --provider anthropic")
		}
