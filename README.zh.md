...
<h1>PonyClaw: 基于Go语言的超高效 AI 助手</h1>

<h3>10$硬件 · 10MB内存 · 1秒启动 · 基于 PicoClaw</h3>
...
> **说明**: PonyClaw 是 [PicoClaw](https://github.com/sipeed/picoclaw) 的分支版本，PicoClaw 是一个受 [nanobot](https://github.com/HKUDS/nanobot) 启发的超轻量级个人 AI 助手。
